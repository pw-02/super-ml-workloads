...
from image_classification.imagenet import run_imagenet
...
def main(config: DictConfig):
    ...
    # # train_args, data_args, dataloader_args = prepare_args(config, f"{config.dataloader.name}_{config.exp_id}/{config.job_id}" )
    ...
    #     os.makedirs(logger.log_dir, exist_ok=True)
    #     save_hparams_to_yaml(os.path.join(logger.log_dir, "hparms.yaml"), config)
