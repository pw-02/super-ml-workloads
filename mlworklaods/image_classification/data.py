...
class BaseDataModule:
    ...
    def make_dataloaders(self, train_args: TrainArgs, data_args: DataArgs, dataloader_args, world_size: int):
    ...
    def make_lru_torch_dataloaders(self, train_args: TrainArgs, data_args: DataArgs, lru_torch_args: LRUTorchArgs, world_size: int) -> Tuple[Optional[DataLoader], Optional[DataLoader]]:
    ...
    def create_lru_dataloader(self, train_args: TrainArgs, data_dir: str, lru_torch_args: LRUTorchArgs, world_size: int) -> DataLoader:
        ...
        batch_sampler = BatchSamplerWithID(sampler=base_sampler, batch_size=train_args.get_batch_size(world_size), drop_last=False)
        return DataLoader(dataset=dataset, sampler=batch_sampler, batch_size=None, num_workers=lru_torch_args.num_pytorch_workers)

    def make_super_dataloaders(self, train_args: TrainArgs, data_args: DataArgs, super_args: SUPERArgs, world_size: int) -> Tuple[Optional[DataLoader], Optional[DataLoader]]:
    ...
    def create_super_dataloader(self, train_args: TrainArgs, data_dir: str, super_args: SUPERArgs, world_size: int) -> DataLoader:
