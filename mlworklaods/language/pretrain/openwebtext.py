...
def setup(
    ...
    fabric.launch(main, devices, resume, seed, Config.from_name(name=model_name), io, train, eval, dataload_delay)
...
class Dataset(IterableDataset):
    def __init__(self, data_file: Path, max_seq_length: int, delay:int):
        super().__init__()
