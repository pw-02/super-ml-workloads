...
class ShadeDataset(Dataset):
	def __init__(self, imagefolders, transform=None, target_transform=None, cache_data = False, PQ=None, ghost_cache=None, 
			  key_counter= None, wss = 0.1, host_ip = '0.0.0.0', port_num = '6379'):
		_datasets = []
		self.samples = []
		self.classes = []
