...
class RandomBatchSamplerWithID(BatchSampler):
...
if __name__ == "__main__":
    ...
    batch_sampler_with_id = RandomBatchSamplerWithID(RandomSampler(data_source=dataset,generator=torch.Generator().manual_seed(42)), 
