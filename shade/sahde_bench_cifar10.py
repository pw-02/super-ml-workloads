...
from shade.shadedataset import ShadeDataset, ShadeValDataset
...
def main():
	...
	# parser.add_argument('train_paths', help="Paths to the train set", default='data/cifar-10')
	...
	parser.add_argument('-cn', '--cache_nodes', default=0, type=int,
						help='number of nodes cache is distributed across')

	args = parser.parse_args()
	args.train_paths = ['data/cifar-10']
