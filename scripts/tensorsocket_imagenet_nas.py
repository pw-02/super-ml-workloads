...
workload_configs = ["imagenet_shufflenet_v2_x1_0", "imagenet_resnet18"]  # Add your workloads here

# Define GPU indices and learning rates
job_ids = [0]
learning_rates = [0.1, 0.2]  # Add your learning rates here
...
for i, workload in enumerate(workload_configs):
    ...
    lr = learning_rates[i]
    gpu_device = 0
    print(f"Starting job on GPU {gpu_device} with workload {workload} and exp_id {expid}_{i}")
