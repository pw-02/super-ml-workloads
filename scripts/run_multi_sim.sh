...
workload="imagenet_resnet50" # Define your workload imagenet_resnet50, cifar10_resnet18, lora_finetune_owt, albef_retrieval
dataloder="coordl" # Define your dataloader shade, super, litgpt
