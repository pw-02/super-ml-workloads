...
class ImageClassifierLogger():
    ...
    def save_train_batch_metrics(self,epoch,step,global_step,num_sampels,total_time,data_time,compute_time,loss, acc1, acc5, avg_cpu, max_cpu, avg_gpu=0, max_gpu=0,
                                 cahce_hit = False):
        metrics = OrderedDict({
...
class ProgressMeter(object):
    ...
    def display(self, batch, fabric:Fabric):
